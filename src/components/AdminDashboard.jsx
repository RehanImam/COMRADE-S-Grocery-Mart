  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="bg-emerald-600 text-white px-4 py-2 rounded-xl font-bold text-sm shadow-md hover:bg-emerald-700 transition">
          + Add New Product
        </button>
      </div>
              ...
              {products.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900 flex items-center gap-3">
                    ...
                    {/* Check whether image is URL or Emoji */}
                    {item.image.startsWith('http') ? (
                      ...
                      <span className="text-2xl w-10 h-10 flex items-center justify-center bg-slate-100 rounded-lg">
                        {item.image}
                      </span>
                    )}
