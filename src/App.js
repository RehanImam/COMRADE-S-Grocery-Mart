...
//   { id: 1, name: "Potato", category: "Vegetable", price: 4.99, unit: "3 Kg", rating: 4.8, image: "🥑", tag: "Organic", stock: 45 },
//   { id: 2, name: "A2 Whole Almond Milk", category: "Fruit", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 3, name: "Artisanal Sourdough Bread", category: "Non-veg", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 4, name: "Cold Pressed Orange Juice", category: "Rice & Grain", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 5, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 6, name: "A2 Whole Almond Milk", category: "Fruit", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 7, name: "Artisanal Sourdough Bread", category: "Oil & Masala", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 8, name: "Cold Pressed Orange Juice", category: "Rice & Grain", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 9, name: "Raw Honeycomb Crisp", category: "Biscuit", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 10, name: "A2 Whole Almond Milk", category: "Fruit", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 11, name: "Artisanal Sourdough Bread", category: "Non-veg", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 12, name: "Cold Pressed Orange Juice", category: "Vegetable", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 13, name: "Raw Honeycomb Crisp", category: "Biscuit", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 14, name: "Artisanal Sourdough Bread", category: "Rice & Grain", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 15, name: "Cold Pressed Orange Juice", category: "Non-veg", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 16, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 17, name: "A2 Whole Almond Milk", category: "Fruit", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 18, name: "Artisanal Sourdough Bread", category: "Oil & Masala", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 19, name: "Cold Pressed Orange Juice", category: "Vegetable", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 20, name: "Raw Honeycomb Crisp", category: "Biscuit", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 21, name: "A2 Whole Almond Milk", category: "Non-veg", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 22, name: "Artisanal Sourdough Bread", category: "Rice & Grain", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 23, name: "Cold Pressed Orange Juice", category: "Vegetable", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 24, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 25, name: "A2 Whole Almond Milk", category: "Fruit", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 26, name: "Artisanal Sourdough Bread", category: "Non-veg", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 27, name: "Cold Pressed Orange Juice", category: "Vegetable", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 28, name: "Raw Honeycomb Crisp", category: "Biscuit", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 29, name: "Artisanal Sourdough Bread", category: "Rice & Grain", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 30, name: "Cold Pressed Orange Juice", category: "Fruit", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 31, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 32, name: "A2 Whole Almond Milk", category: "Oil & Masala", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 33, name: "Artisanal Sourdough Bread", category: "Non-veg", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 34, name: "Cold Pressed Orange Juice", category: "Vegetable", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 35, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 36, name: "A2 Whole Almond Milk", category: "Oil & Masala", price: 3.89, unit: "1 Liter", rating: 4.9, tag: "Best Seller", stock: 18 },
//   { id: 37, name: "Artisanal Sourdough Bread", category: "Bakery", price: 5.49, unit: "500g", rating: 4.7, tag: "Fresh Daily", stock: 12 },
//   { id: 38, name: "Cold Pressed Orange Juice", category: "Fruit", price: 6.29, unit: "750ml", rating: 4.6, tag: "No Sugar", stock: 30 },
//   { id: 39, name: "Raw Honeycomb Crisp", category: "Snacks", price: 7.99, unit: "250g", rating: 4.9, tag: "Premium", stock: 8 },
//   { id: 40, name: "Fresh Greek Yogurt", category: "Non-veg", price: 4.29, unit: "400g", rating: 4.8, tag: "High Protein", stock: 25 },
// ];
...
//       <div className="bg-emerald-900 text-emerald-100 text-xs px-4 py-2 flex justify-between items-center">
//         <span>🚀 Free Express Local Delivery on orders over $35 | <strong>COMRADE'S MART</strong></span>
...
//           {/* Hero Banner */}
//           <div className="mb-8 rounded-3xl bg-gradient-to-r from-emerald-700 to-teal-800 text-white p-8 sm:p-12 shadow-xl relative overflow-hidden">
//             <div className="max-w-xl z-10 relative">
//               <span className="inline-block px-3 py-1 rounded-full bg-emerald-500/30 text-emerald-200 text-xs font-semibold uppercase tracking-wider mb-3">
...
//                 Get hand-picked organic fruits, artisan dairy, and daily essentials guaranteed fresh within 2 hours.
//               </p>
//               <a href="#products" className="inline-block bg-amber-400 hover:bg-amber-300 text-slate-900 font-bold px-6 py-3 rounded-xl transition shadow-lg">
//                 Shop Fresh Now →
//               </a>
//             </div>
//           </div>
...
//             <h2 className="text-xl font-bold text-slate-900 mb-4">Explore Categories</h2>
//             <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none">
//               {['All', 'Vegetable', 'Fruit', 'Non-veg', 'Rice & Grain','Oil & Masala', 'Biscuit', 'Snacks'].map((cat) => (
//                 <button
//                   key={cat}
//                   onClick={() => setSelectedCategory(cat)}
//                   className={`px-5 py-2.5 rounded-2xl text-sm font-semibold whitespace-nowrap transition ${
...
export const INITIAL_PRODUCTS = [
  ...
  { id: 20, name: "Oat Biscuits", category: "Biscuit", price: 7.99, unit: "250g", rating: 4.9, image: "https://images.unsplash.com/photo-1548365328-8c6db4b6fe16?auto=format&fit=crop&w=800&q=80", tag: "Premium", stock: 8 },
  ...
  { id: 36, name: "Olive Oil", category: "Oil & Masala", price: 3.89, unit: "1 Liter", rating: 4.9, image: "https://images.unsplash.com/photo-1508861326848-8a8b11119b48?auto=format&fit=crop&w=800&q=80", tag: "Best Seller", stock: 18 },
